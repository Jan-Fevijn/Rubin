        ...
        Using conn = New MySqlConnection(connStr)
            ...
            Try
                Using cmd As New MySqlCommand(query, conn)
                    ...
                    cmd.Parameters.AddWithValue("@idAutomaat", idAutomaat.id)
                    cmd.Parameters.AddWithValue("@idKlant", idKlant.id)
                ...
                Using cmd As New MySqlCommand(query, conn)
                    ...
                    Using reader = cmd.ExecuteReader(CommandBehavior.CloseConnection)
                        If reader.Read() Then
                            ...
                            myObj.idAutomaat.id = Convert.ToInt32(reader("idAutomaat"))
                            myObj.idKlant.id = Convert.ToInt32(reader("idKlant"))
                            myObj.id = Convert.ToInt32(reader("idTransactie"))
                        End If
                    End Using
                End Using
                Return myObj
